...
output_path = r".\moral_conflicts.json"
...
for item in new_data:
    if item['ID'] not in existing_data_ids and item['human_evaluation'] == 1:
        new_item = {"ID": item['ID'], "moral_conflict": item['moral_conflict'], "norm": item['norm'], "action": item['action'], "conflict_norm": item['conflict_norm'], "conflict_action": item['conflict_action'], "rot_category": item['rot_category']}
